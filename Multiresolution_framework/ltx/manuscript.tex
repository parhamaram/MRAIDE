...
\author{In no particular order: \parham{P. Aram}, \mike{M. Dewar}, \dean{D.R. Freestone,~\IEEEmembership{Graduate Student Member,~IEEE,}}, \ken{K.Scerri}, D.B. Grayden,~\IEEEmembership{Member,~IEEE,} and V. Kadirkamanathan % <-this % stops a space
