...
\parham{
 \begin{itemize}
	...
	\item so when we have joint state parameter estimation for stae-space models  we only need to do two things: 1- use smoother for the E-step 2- construct the lower bound which might not be straightforward even in linear case
\end{itemize}}
