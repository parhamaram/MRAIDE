...
\begin{figure}[!t]
\centering
\includegraphics[scale=.8]{./Graph/ModelComponents.pdf}
\caption{ {\bf The IDE neural field model components}. (\textbf{A}) The Mexican hat (red) and Wizard hat (blue) connectivity kernels. (\textbf{B}) First order (red) and second order (blue) synaptic kernels. (\textbf{C}) A representative of the activation function.}
