...
\end{equation}
 Where the subscript $m$ is introduced to $\phi_{j,l}(s)$ and $\psi_{j,l}(s) $ to indicate the $m$th order B-spline scaling and wavelet functions.  
% In the two dimensional case, the convolution integral can be factorised as follows, e.g. 
...
\end{align}
Where
\begin{equation}\label{eq:upsilon0}
 \boldsymbol\upsilon_0=\sum_{i,j=1}^{n_x}[\boldsymbol\Xi_0]_{i,j}[\Sigma_{w}^{-1}\boldsymbol\Lambda_{x}^{-1}\mathbf U]_{j,i} \quad,
\end{equation}
\begin{equation}\label{eq:upsilon1}
 \boldsymbol\upsilon_1=\xi\sum_{i,j=1}^{n_x}[\boldsymbol\Xi_1]_{i,j}[\Sigma_{w}^{-1}\boldsymbol\Lambda_{x}^{-1}\mathbf U]_{j,i} \quad,
\end{equation}
\begin{equation}\label{eq:Upsilon}
 \boldsymbol\Upsilon=T_s\sum_{i,j=1}^{n_x}[\boldsymbol\Xi_1]_{i,j}[\mathbf{U}^{\mathsf T} \boldsymbol\Lambda_{x}^{-1}\Sigma_{w}^{-1}\boldsymbol\Lambda_{x}^{-1}\mathbf{U}]_{j,i},
\end{equation}
