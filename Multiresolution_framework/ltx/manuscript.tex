...
of Electrical and Electronic Engineering, The University of Melbourne, and The Bionic Ear Institute, VIC, Australia, (e-mail: dfreestone@bionicear.org; grayden@unimelb.edu.au)}
...
of Malta, Msida, MSD 2080, Malta (e-mail: kenneth.scerri@um.edu.mt).}}
% <-this % stops a space
...
\end{align}
where $[.]_{i,j}$ denotes $\left(i,j\right)^{th}$ (block) element of the (block) matrix. Each $1\times n_{\theta}$ block of the $n_x \times n_x$ block matrix.
