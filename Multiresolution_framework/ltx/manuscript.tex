...
\end{cases}
\end{align}
\parham{One important feature of B-spline is the \emph{partition of unity} property, meaning that the unity can be expressed as a linear sum of B-splines, i.e
\begin{equation}
