...
\end{abstract} 
%\begin{keyword}
 % Neural Field Model \sep multi-resolution approximation (MRA) \sep Expectation Maximisation (EM) algorithm \sepWavelets
%\end{keyword}
...
\begin{tabular}{|l|l|l|}
	...
	$\tau$, $\xi$ & \parham{synaptic time constant} \& time constant parameter & s, n.a.\\
