...
\author[TNG,US]{P. Aram\corref{cor1}}
...
\begin{tabular}{|l|l|l|}
	...
	$\mathbb{R}$&The set of all real numbers&n.a.\\
	$\mathbb{Z}$&The set of all integers&n.a.\\
...
To calculate the frequency response of the B-spline wavelet the Fourier transform of $N_1(r)$ is first calculated, 
