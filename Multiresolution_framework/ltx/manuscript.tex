...
\begin{equation}
	...
	\end{equation}
	\parham{This is important as the underlying field can be reconstructed when its saturated without introducing numerical errors which is not the case for example in the case of Gaussian basis functions.}
