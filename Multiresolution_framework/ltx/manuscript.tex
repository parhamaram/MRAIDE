...
\caption{ {\bf The IDE neural field model components}. (\textbf{A}) The Mexican hat (solid line) and Wizard hat (dotted line) connectivity kernels. (\textbf{B}) First order (dotted line) and second order (solid line) synaptic kernels. (\textbf{C}) A representative of the activation function.}
