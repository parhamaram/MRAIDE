...
\begin{figure}[!h] 
	\centering
		...
		\caption{Connectivity kernel estimate. (a) The actual kernel is shown with the black solid line. The estimated kernel and confidence interval is shown by the red line and red shaded region ($\pm2$ std.). (b) Weighted kernel scaling functions at $j=1$. (c) Weighted kernel wavelet functions at $j=1$.}
