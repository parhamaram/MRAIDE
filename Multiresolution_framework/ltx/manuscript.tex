...
\caption{{\bf Examples of cardinal B-spline functions}. Piecewise polynomial functions (dotted lines) are joined at the break points (black circles). (\textbf{A}) B-spline function of order 2 (linear B-spline). (\textbf{B}) B-spline function of order 8.}
\label{fig:Figure0}
\end{figure}
