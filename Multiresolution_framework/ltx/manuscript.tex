...
\caption{{\bf Schematic of the EM algorithm}. The RTS smoother (E-step) and the maximisation of the lower bound (M-step) are shown. The dashed box shows the iterative two step algorithm once it is initialised.}
