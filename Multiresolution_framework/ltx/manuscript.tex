...
\begin{figure}[t]
	...
	\caption{{\bf Actual and estimated spatiotemporal neural field at different spatial resolutions}. (\textbf{A}) The reconstructed field of the reduced model using only scaling functions at $j=0$. (\textbf{B}) The reconstructed field using scaling and wavelet functions at $j=0$. (\textbf{C}) The reconstructed field using scaling and wavelet functions at $j=1$. (\textbf{D}) The reconstructed field using scaling and wavelet functions at $j=2$. (\textbf{E}) The reconstructed field using scaling and wavelet functions at $j=3$. (\textbf{F}) The actual field.}
