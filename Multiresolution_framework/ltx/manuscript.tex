...
\begin{figure}[t]
 	\centering
 		...
 		\caption{{\bf Convergence of the EM based algorithm}. The mean  of
the $\mathbf A(\boldsymbol\theta)$ Frobenius norm over 200 realizations vs iterations of the EM based algorithm. The change in the stopping criterion falls below $10^{-6}$ after less than 10 iterations.} 
