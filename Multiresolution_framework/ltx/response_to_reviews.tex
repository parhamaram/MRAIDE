...
\emph{\dean{We understand that this section will not be the central focus of the paper for the non-technical reader. This was the motivation for the comments in the section introduction, where we state... Although we appreciate R1 comments and suggestions, since R2 commented on the usefulness of this section we would very much like to leave it in.} \parham{As the reviewer suggested the calculation of the Fourier transform is now moved to the appendix.}}
