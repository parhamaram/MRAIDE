...
\emph{\dean{The inverse framework in Dewar et al. (2009) is based on a general integro-differential equation model, which is not suitable when neural field models are considered. As a result, the necessary modifications have been made. }}
...
\end{enumerate}  
    ...
    \subsection{Main Concerns}
		\begin{enumerate} 
			...
			% \emph{\parham{To respond to this comment we have added ``State-space representation'' subsection into the discussion.}}
